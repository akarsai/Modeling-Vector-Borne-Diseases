...
# plot fit
# TODO create automatic fit-analysis as part of class OptimizationProblem
...
# plt.title('Fit for the Democratic Republic of Congo')
plt.xlim(0,17)
plt.xticks([x for x in range(18)],['\''+str(2000+x)[-2:] for x in range(18)])
plt.xlabel('Year')
plt.ylabel('Number of individuals')
plt.legend()
plt.savefig('plots/fit_drc.pgf')
plt.show()
